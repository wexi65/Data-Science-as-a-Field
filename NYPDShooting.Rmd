...
```{r Replace NA with UNKNOWN, echo = FALSE}
...
```{r visualizing and analyzing shooting in NY, echo = FALSE}
...
```{r visualizing and analyzing shooting in Queens, echo = FALSE}
...
```{r visualizing and analyzing shooting in Manhattan, echo = FALSE}
